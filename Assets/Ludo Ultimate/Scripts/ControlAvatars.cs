...
public class ControlAvatars : MonoBehaviour
{
    ...
    public void reset()
    {
        ...
        if ((GameManager.Instance.type == MyGameType.Private || GameManager.Instance.type == MyGameType.Online) && !GameManager.Instance.JoinedByID)
        {
        ...
        if (GameManager.Instance.type == MyGameType.Private   && !GameManager.Instance.JoinedByID)
        {
            ...
            startButtonPrivate.SetActive(true);

            RoomIDText.GetComponent<Text>().text = "Fetching...";
        }
        else if(GameManager.Instance.type == MyGameType.Online  && !GameManager.Instance.JoinedByID){
            RoomIDObject.SetActive(true);
            shareButton.SetActive(false);
            startButtonPrivate.SetActive(false);

            RoomIDText.GetComponent<Text>().text = "Waiting...";
        }
        else
        {
            RoomIDObject.SetActive(false);
